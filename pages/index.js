        ...
        >
          <div className="container px-5 py-24 mx-auto">
            <div className="flex flex-wrap -m-4 ">
              ...
              <div className="xl:w-1/3 md:w-1/2 p-4 mb-6">
                <Image
                  src="https://gamingshop.vercel.app/Images/mainpc.jpg"
                  height={1100}
                  width={1100}
                />
              </div>
              ...
              <div className="xl:w-1/3 md:w-1/2 p-4 mb-6">
                <Image
                  src="https://gamingshop.vercel.app/Images/monitor1.png"
                  alt="Design"
                  height={1100}
                  width={1100}
                />
              ...
              <div className="xl:w-1/3 md:w-1/2 p-4 mb-6">
                <Image
                  src="https://gamingshop.vercel.app/Images/mousepad.png"
                  alt="Design"
                  height={1100}
                  width={1100}
                />
              ...
              <div className="xl:w-1/3 md:w-1/2 p-4 mb-6">
                <Image
                  src="https://gamingshop.vercel.app/Images/headphone.png"
                  alt="Design"
                  height={1100}
                  width={1100}
                />
